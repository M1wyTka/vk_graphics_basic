...
public:
  ...
  const std::string FRAGMENT_SHADER_PATH = "../src/samples/bad_optimization/shaders/simple_bad_optimization.frag";
...
protected:
  ...
  //pipeline_data_t m_cullingComputePipeline{};
  VkPipeline m_cullingComputePipeline;
  VkPipelineLayout m_cullingComputePipelineLayout;

  VkDescriptorSet m_cullDSet             = VK_NULL_HANDLE;
  VkDescriptorSetLayout m_cullDSetLayout = VK_NULL_HANDLE;
